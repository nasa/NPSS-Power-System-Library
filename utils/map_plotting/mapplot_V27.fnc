...
void saveOpPoints( string info ) {
   ...
   for ( n=0; n < COMPONENT_NAMES.entries(); ++n ) {
      ...
      DATA_MAP.open( "output/mapData" + COMPONENT_NAMES[n] + ".txt" );
      DATA_MAP.width = 0;
...
void createMapDataFiles() {
   ...
   //-------------------------------------------------------------------------
   COMPONENT_FILE.filename = "output/mapCompList.txt";
   COMPONENT_FILE << "component_list=[ ";

   for ( n=0; n < COMPONENT_NAMES.entries(); ++n ) {
      COMPONENT_FILE << "\"" << "output/mapData" + COMPONENT_NAMES[n] + ".txt" << "\", ";
   } 
   ...
   for ( n=0; n < COMPONENT_NAMES.entries(); ++n ) {
      ...
      DATA_MAP.width = 0;
      DATA_MAP.filename = "output/mapData" + COMPONENT_NAMES[n] + ".txt";
